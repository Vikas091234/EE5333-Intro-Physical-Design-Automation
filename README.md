...
This repository intentionally contains a mixture of:

- assignment source code,
- notebooks,
- assignment statements/reports,
- benchmark data,
- project documentation,
- generated DEF outputs,
- Python scripts,
- compiled parser binaries,
- Python wheel/package artifacts.

Therefore, this README documents the **actual supplied repository**, including committed binary/deployment artifacts, instead of presenting an idealized clean-source-only structure.

The repository currently has no top-level `requirements.txt`, `src/` directory, or generic `placement` implementation directory. The corresponding project source path is `project/scr/`, and Assignment 5 is graph isomorphism.
